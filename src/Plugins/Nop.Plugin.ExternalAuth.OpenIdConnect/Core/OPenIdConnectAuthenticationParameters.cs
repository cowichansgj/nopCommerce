...
{
    public class OpenIdConnectAuthenticationParameters : OpenAuthenticationParameters
    {
        private readonly string _providerSystemName;
        private IList<UserClaims> _claims;
        public OpenIdConnectAuthenticationParameters(string providerSystemName)
        {
